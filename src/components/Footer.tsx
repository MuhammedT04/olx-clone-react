const Footer = () => {
  return (
    <>
      <div>
        <div className="bg-[#EBEEEF] flex space-x-28 py-5 px-10">
          <div className="list-none">
            <h1 className="font-bold text-sm text-[#002F34] pb-2">
              POPULAR LOCATIONS
            </h1>
            <li className="text-[#406367] text-[12px]">Kolkata</li>
            <li className="text-[#406367] text-[12px]">Mumbai</li>
            <li className="text-[#406367] text-[12px]">Chennai</li>
            <li className="text-[#406367] text-[12px]">Pune</li>
          </div>
          <div className="list-none">
            <h1 className="font-bold text-sm text-[#002F34] pb-2">
              TRENDING LOCATIONS
            </h1>
            <li className="text-[#406367] text-[12px]">Bhubaneshwar</li>
            <li className="text-[#406367] text-[12px]">Hyderabad</li>
            <li className="text-[#406367] text-[12px]">Chandigarh</li>
            <li className="text-[#406367] text-[12px]">Nashik</li>
          </div>
          <div className="list-none">
            <h1 className="font-bold text-sm text-[#002F34] pb-2">ABOUT US</h1>
            <li className="text-[#406367] text-[12px]">Tech@OLX</li>
          </div>
          <div className="list-none">
            <h1 className="font-bold text-sm text-[#002F34] pb-2">OLX</h1>
            <li className="text-[#406367] text-[12px]">Blog</li>
            <li className="text-[#406367] text-[12px]">Help</li>
            <li className="text-[#406367] text-[12px]">Sitemap</li>
            <li className="text-[#406367] text-[12px]">
          ...
          <div>
            <h1 className="font-bold text-sm text-[#002F34]">FOLLOW US</h1>
            <div className="flex w-12 gap-x-2">
              <a
                href="https://www.facebook.com/olxindia/"
                target="_blank"
                rel="noopener noreferrer"
                className="QUhEK"
                data-aut-id="Facebook"
              >
                <span className="_1qtOc" role="listbox" id="" data-aut-id="">
                  <svg
                    width="24px"
                    height="48px"
                  ...
                  >
                    <path
                      className="rui-w4DG7"
                      d="M697.376 565.332L719.489 410.898H581.163V310.679C581.163 268.429 600.485 227.246 662.442 227.246H725.334V95.7681C725.334 95.7681 668.257 85.3333 613.689 85.3333C499.764 85.3333 425.303 159.295 425.303 293.194V410.898H298.667V565.332H425.303V938.667H581.163V565.332H697.376V565.332Z"
                    ></path>
                  </svg>
                </span>
              </a>
              ...
              <a
                href="https://www.instagram.com/olx_india/"
                target="_blank"
                rel="noopener noreferrer"
                className="QUhEK"
                data-aut-id="Instagram"
              >
                <span className="_1qtOc" role="listbox" id="" data-aut-id="">
                  <svg
                    width="24px"
              ...
              <a
                href="https://www.youtube.com/user/OLXInTv"
                target="_blank"
                rel="noopener noreferrer"
                className="QUhEK"
                data-aut-id="Youtube"
        ...
        <div className="bg-[#002F34] text-white pt-8">
          <div className="px-8 flex">
            <div className="w-[20%] border border-s-0 border-t-0 border-b-0 me-16">
            <img className="w-[80%]" src="https://statics.olx.in/external/base/img/cartrade/logo/cartrade_tech.svg?v=1" alt="" />
            </div>
            <div className="flex w-[80%] gap-x-24">
            <img className="w-[6%]" src="https://statics.olx.in/external/base/img/cartrade/logo/olx.svg?v=1" alt="" />
            <img className="w-[12%]" src="https://statics.olx.in/external/base/img/cartrade/logo/carwale.svg?v=1" alt="" />
            <img className="w-[12%]" src="https://statics.olx.in/external/base/img/cartrade/logo/bikewale.svg?v=1" alt="" />
            <img className="w-[12%]" src="https://statics.olx.in/external/base/img/cartrade/logo/cartrade.svg?v=1" alt="" />
            <img className="w-[12%]" src="https://statics.olx.in/external/base/img/cartrade/logo/mobility.svg?v=1" alt="" />
            </div>
          </div>
          <div className="py-5 px-8 flex justify-between">
            <h1 className="text-[12px]">Help - Sitemap</h1>
            <h1 className="text-[12px]">All rights reserved © 2006-2024 OLX</h1>
          </div>
        </div>
      </div>
    </>
